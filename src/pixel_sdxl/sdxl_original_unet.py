# Copy from sd-scripts repoitory:
# http://github.com/kohya-ss/sd-scriptsz
...
class SdxlUNet2DConditionModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, **kwargs):
        return_encoder_features = kwargs.get("return_encoder_features", False)
        return_decoder_features = kwargs.get("return_decoder_features", False)
        ...
        def call_module(module, h, emb, context, skip_last=False):
            x = h
            for i, layer in enumerate(module):
                if skip_last and i == (len(module) - 1):
                    break
        ...
        for i, module in enumerate(self.input_blocks):
            ...
            if return_encoder_features and i == 6:
                return h
            hs.append(h)
        ...
        for i, module in enumerate(self.output_blocks):
            ...
            h = call_module(module, h, emb, context, skip_last=(i==2))
            if i == 2 and return_decoder_features:
                return h
